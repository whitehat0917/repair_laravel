...
Route::middleware('user')->group(function () {
    //Route::name('login')->get('/', 'Front\LoginController@index');
    Route::get('/', 'Front\PostController@index');
    Route::name('home')->get('/', 'Front\PostController@index');
    Route::name('post')->get('/post', 'Front\PostController@index');
    Route::name('post.create')->post('/post_create', 'Front\PostController@create');
    Route::name('post.download')->post('/post_download', 'Front\PostController@savePDF');
});
...
Route::prefix('admin')->namespace('Back')->group(function () {
    ...
    Route::middleware('redac')->group(function () {
        ...
        Route::name('post.change_status')->post('/post_change_status', 'PostController@change_status');
        Route::name('post.note')->post('/post_note', 'PostController@note');
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::name('users.reset')->get('users/reset/{user}', 'UserController@reset');
