...
@section('button')
    <a href="{{ route('posts.create') }}" class="btn btn-primary">@lang('New Repair')</a>
@endsection
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <input type="checkbox" name="new" @if(request()->new) checked @endif> @lang('Closed Repairs')&nbsp;
                    <input type="checkbox" name="active" @if(request()->active) checked @endif> @lang('New Repairs')&nbsp;
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        <thead>
                        <tr>
                            <th>@lang('Customer')<span id="customer" class="fa fa-sort pull-right"
                                                              aria-hidden="true"></span></th>
                            <th>@lang('Title')<span id="title" class="fa fa-sort pull-right"
                                                              aria-hidden="true"></span></th>
                            <th>@lang('IMEI')<span id="imei" class="fa fa-sort pull-right"
                                                              aria-hidden="true"></span></th>
                            <th>@lang('Problem')<span id="problem" class="fa fa-sort pull-right"
                                                              aria-hidden="true"></span></th>
                            <th>@lang('Note')<span id="problem" class="fa fa-sort pull-right"
                                                              aria-hidden="true"></span></th>
                            <th>@lang('Creation')<span id="created_at" class="fa fa-sort-desc pull-right"
                                                              aria-hidden="true"></span></th>
                            <th>@lang('Status')<span id="status" class="fa fa-sort pull-right"
                                                              aria-hidden="true"></span></th>
                            <th>@lang('Repair ID')<span id="repair_id" class="fa fa-sort pull-right"
                                                              aria-hidden="true"></span></th>
                            <th></th>
                            <th></th>
                            <th></th>
