                            ...
                            <div class="tab-pane fade" id="tab_1">
                                <form method="post" action="{{ route('settings.update', ['page' => 1]) }}">
                                    ...
                                    <div class="form-group">
                                        <label for="autoemail">@lang('Send Email Automatically')</label>
                                        <select id="autoemail" name="autoemail" class="form-control">
                                            <option value="true" {{ old('autoemail') ? ('true' === old('autoemail') ? 'selected' : '') : 'true' === $actualAutoemail ? 'selected' : '' }}>Yes</option>
                                            <option value="false" {{ old('autoemail') ? ('false' === old('autoemail') ? 'selected' : '') : 'false' === $actualAutoemail ? 'selected' : '' }}>No</option>
                                        </select>
                                    </div>
