@foreach($users as $user)
    <tr>
        ...
        <td><a class="btn btn-info btn-xs btn-block" href="{{ route('users.reset', [$user->id]) }}" role="button" title="@lang('Reset Password to 123456')"><span class="fa fa-key"></span></a></td>
