        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <input type="radio" name="role" value="user"> @lang('User')&nbsp;
                    ...
                    <a class="btn btn-primary btn-xs button-padding float-right fs-15" href="{{ route('users.create') }}" role="button" title="@lang('Create')">Create</a>
                </div>
